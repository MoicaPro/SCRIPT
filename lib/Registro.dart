...
import 'package:practica01/principal.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: <String,WidgetBuilder>{
        "/Prinicpal":(BuildContext context)=>principal(),
      },
        ...
        child: Row(
          ...
          children: [
            ...
            Align(
              ...
              child: Text("Registra", style: TextStyle(fontSize: 15.0, color: Colors.white)),
            ),
            SizedBox(width: 70.0),
          ],
        ),
          ...
          child: Row(
            ...
            children: [
              ...
              MaterialButton(onPressed:(){Navigator.push(
                ...
                child: Text("Inicia", style: TextStyle(color: const Color.fromARGB(255, 62, 160, 65), fontSize: 20.0)),
              )
            ],
          ),
        ),
